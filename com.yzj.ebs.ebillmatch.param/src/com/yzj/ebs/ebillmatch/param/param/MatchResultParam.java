package com.yzj.ebs.ebillmatch.param.param;

public class MatchResultParam implements java.io.Serializable {
	/**
	 * 
	 */
	private static final long serialVersionUID = 8297947020152684722L;
	private String idCenter; //分行
	private String idBank;// 机构号
	private String bankName;// 机构名称
	private String accNo;// 账号
	private String accNoSon;// 子账号
	private String accName;// 账户名称
	private String docDate;// 对账日期，结果中暂未获得
	...
	public MatchResultParam() {
	}

	public MatchResultParam(String idCenter,String idBank, String bankName, String accNo,
			String accNoSon, String accName, String MatchCount1,
			String MatchCount2, String MatchCount3, String MatchCount4,
			String MatchCount5, String MatchCount6) {
