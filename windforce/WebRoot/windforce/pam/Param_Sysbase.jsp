...
%>
<body>
	<cp:condition showname="系统运行参数查询">
		<cp:text showname="参数ID"   ref="extFields.sysbaseID" maxlength="64" ></cp:text>
		<cp:text showname="参数值"    ref="extFields.sysbaseValue" maxlength="64" ></cp:text>
	</cp:condition>
	<cp:content showname="系统运行参数管理">
		<%
		...
		<cp:pagecolumn showname="参数ID"  width="120px"  ref="extFields.sysbaseID"></cp:pagecolumn>
		<cp:pagecolumn showname="参数值"  width="120px"  ref="extFields.sysbaseValue"></cp:pagecolumn>
		<cp:pagecolumn showname="参数描述"  width="120px"  ref="extFields.sysbaseMemo"></cp:pagecolumn>		
		<%
		if(null != request.getParameter("edit") && request.getParameter("edit").equals("true")){ %>
	...
	<cp:operatediv opertype="add">
		...
		<cp:text showname="参数ID"   requiredLabel="true"  ref="extFields.sysbaseID" ></cp:text>
		<cp:text showname="参数值"    ref="extFields.sysbaseValue"  requiredLabel="true" maxlength="64" ></cp:text>
		<cp:text showname="参数描述"    ref="extFields.sysbaseMemo"   maxlength="64"></cp:text>
	</cp:operatediv>
