...
<script type="text/javascript" src="<%=path%>/ebs/common/js/sealAccnoModify.js"></script>
...
<script type="text/javascript">
	...
	function toExportData() {
		...
		if (objTable.rows.length>2) {
			window.location.href = "sealAccnoModifyAction_exportData.action";
		}else{
			alert("查询结果无数据");
		}
	}	
...
<body class="baby_in2">
	...
	<input id="moudleName" type="hidden" value="账户验印账号维护"/>
	<div id="son_div" class="son_div">
		...
		<jsp:include page="/ebs/sealAccnoModify/sealAccnoModify_div.jsp" />
	</div>
	
	<div id="nov_nr" class="nov_nr">
		<form id="accModifyForm"
					action="sealAccnoModifyAction_queryAccData.action" name="accModify"
					method="post">
		<div class="nov_moon">
			<div
				...
				class="border_bottom01">
					<table width="98%">
						...
						<tr>
							...
							<td width="20%">验印账号&nbsp;&nbsp; 									
								<input name="acountQueryParam.sealAccno" type="text"
									class="diinput_text01" id="sealAccno" maxlength="128"
									value='<s:property value="acountQueryParam.sealAccno"/>' />
							</td>
							<td width="20%">账户类型&nbsp;&nbsp; 
