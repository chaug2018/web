...
<script type="text/javascript">
	function toExportData() {
		...
		if (objTable.rows.length > 2) {
			window.location.href = 'ebillMatchDetailReport_exportData.action';
		} else {
			alert("统计列表无数据");
		}
	}
...
<body class="baby_in2">
	...
	<form id="ebillMatchAnalyseForm" action="ebillMatchDetailReport_analyse.action"
