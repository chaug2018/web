...
<script type="text/javascript">
	function toExportData() {
		...
		if (objTable.rows.length > 3) {
			window.location.href = "ebillMatchReport_exportData.action";
		} else {
			alert("统计列表无数据");
		}
	}
...
<body class="baby_in2">
	...
	<form id="ebillMatchAnalyseForm" action="ebillMatchReport_analyse.action"
		...
		<div class="nov_moon">
			...
			<div style="width:98%; height:auto; float:left; margin-left:10px; padding:10px 0px 10px 0px;">
				...
				<table width="100%" border="0"  cellpadding="0" cellspacing="0"
					...
					<thead>
						<tr>
							<td style="border:1px solid #C76C6F" width="6%"  align="center" bgcolor="#c76c6f" rowspan="2"
								class="font_colors01">序号</td>
							<td style="border:1px solid #C76C6F" width="8%"  align="center" bgcolor="#c76c6f" rowspan="2"
								class="font_colors01">网点</td>
							<td style="border:1px solid #C76C6F" width="14%"  align="center" bgcolor="#c76c6f" rowspan="2"
