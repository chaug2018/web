...
<script type="text/javascript">
	function toExportData() {
		...
		if (objTable.rows.length > 2) {
			window.location.href = 'sealReport_exportData.action';
		} else {
			alert("统计列表无数据");
		}
	}
...
<body class="baby_in2">
	...
	<form id="sealAnalyseForm" action="sealReport_analyse.action" name="sealAnalyse" method="post">
		<div class="nov_moon">
				...
				<table width="98%" border="0" cellpadding="0" cellspacing="0" id="analyseResultTable">
					<thead>
						<tr>
							...
							<td width="10%" align="center" bgcolor="#c76c6f"
								class="font_colors01">自动验印通过率</td>
							<td width="10%" align="center" bgcolor="#c76c6f"
								class="font_colors01">验印通过率</td>
						</tr>
					</thead>
