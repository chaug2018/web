...
<script language="javascript" type="text/javascript">
	...
	$(document).ready(function(){
		prepareEnd("fstManuProveAction");
		BeginManualSeal(manuproveJson);
	});
</script>
</head>

<body class="baby_in2" LANGUAGE=javascript onunload="EndManualSeal()">
<%@ include file="/ebs/taskviewtool/reasons_div.jsp"%>
<script type="text/javascript">preparePage("<%=path%>");</script>
<input id="moudleName" type="hidden" value="人工初验"/>
<div id="nov_nr1">
<table>
	<tr>
		<td>
			<OBJECT name="ManuSeal" id="ManuSeal"
				...
				classid="clsid:0935F84F-7AC0-48E0-9E25-983791FA11A9" width="780"
				height="650">
