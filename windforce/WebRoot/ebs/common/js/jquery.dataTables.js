...
(/** @lends <global> */function($, window, document, undefined) {
	...
	var DataTable = function( oInit )
	{
		...
		function _fnBuildHead( oSettings )
		{
			...
			//jiangzhengqiu add 兼容ie6用于表头红色背景
			$(oSettings.nTHead).children('tr').attr('style', 'background-color: #c76c6f;color:#FFFFFF');
			$(oSettings.nTHead).children('tr').children("th").attr('style', 'background-color: #c76c6f');
