...
(function() {
	...
	function Id() {
		...
		Nc = a ? Date.UTC : function(b, c, d, e, f, g) {
			return (new Date(b, c, A(d, 1), A(e, 0), A(f, 0), A(g, 0)))
					.getTime()
		};
		hd = a ? "getUTCMinutes" : "getMinutes";
		id = a ? "getUTCHours" : "getHours";
		jd = a ? "getUTCDay" : "getDay";
		Ac = a ? "getUTCDate" : "getDate";
		Oc = a ? "getUTCMonth" : "getMonth";
		Pc = a ? "getUTCFullYear" : "getFullYear";
		Jd = a ? "setUTCMinutes" : "setMinutes";
		Kd = a ? "setUTCHours" : "setHours";
		kd = a ? "setUTCDate" : "setDate";
	...
	function Nd(a, b) {
		function c(p) {
							...
							u(
									...
									function(F) {
										if (r.isCartesian
												&& (F === "xAxis" && xa || F === "yAxis"
														&& !xa)
												&& (r.options[F] === o.index || r.options[F] === Wa
														&& o.index === 0)) {
											r[F] = I;
											zb.push(r);
											t = true
							...
							if (t) {
								...
								if (r.isCartesian) {
									u(
											r.data,
											function(F) {
												var O = F.x, S = F.y, aa = S < 0, Eb = aa ? Q
														: E, kb = aa ? $ : fa;
												if (pa === null)
													pa = wa = F[qa];
												if (xa)
			...
			function da() {
				...
				k = o.maxZoom
						|| (xa && !K(o.min) && !K(o.max) ? sb(
								l.smallestInterval * 5, wa - pa) : null);
				ya = R ? Da : Aa;
				if (Ub) {
				...
				if (ra - ia < k) {
					...
					ra = sb(ia + k, A(o.max, ia + k), wa)
				}
				if (!Ya && !Tc && !Ub && K(ia) && K(ra)) {
					k = ra - ia || 1;
				...
				Ta = ia === ra ? 1 : Ub && !J
						&& E === t.options.tickPixelInterval ? t.tickInterval
						: A(J, Ya ? 1 : (ra - ia) * E / ya);
				if (!D && !K(o.tickInterval))
					Ta = N(Ta);
				I.tickInterval = Ta;
				Uc = o.minorTickInterval === "auto" && Ta ? Ta / 5
						: o.minorTickInterval;
				if (D) {
					Ba = [];
					J = Xa.global.useUTC;
					var Q = 1E3 / tb, fa = 6E4 / tb, ka = 36E5 / tb;
					E = 864E5 / tb;
					k = 6048E5 / tb;
					r = 2592E6 / tb;
					var $ = 31556952E3 / tb, F = [
							...
							[ "day", E, [ 1, 2 ] ], [ "week", k, [ 1, 2 ] ],
							[ "month", r, [ 1, 2, 3, 4, 6 ] ],
							[ "year", $, null ] ], O = F[6], S = O[1], aa = O[2];
					...
					if (S >= Q)
						aa
								.setSeconds(S >= fa ? 0 : F
										* lb(aa.getSeconds() / F));
					if (S >= fa)
						aa[Jd](S >= ka ? 0 : F * lb(aa[hd]() / F));
					if (S >= ka)
						aa[Kd](S >= E ? 0 : F * lb(aa[id]() / F));
					if (S >= E)
						aa[kd](S >= r ? 1 : F * lb(aa[Ac]() / F));
					if (S >= r) {
						aa[Ld](S >= $ ? 0 : F * lb(aa[Oc]() / F));
						n = aa[Pc]()
					}
					if (S >= $) {
						n -= n % F;
					...
					S === k && aa[kd](aa[Ac]() - aa[jd]() + o.startOfWeek);
					t = 1;
					n = aa[Pc]();
					Q = aa.getTime() / tb;
					fa = aa[Oc]();
					for (ka = aa[Ac](); Q < ra && t < Da;) {
						Ba.push(Q);
						if (S === $)
							Q = Nc(n + t * F, 0) / tb;
						else if (S === r)
							...
							Q = Nc(n, fa, ka + t * F * (S === E ? 1 : 7));
						else
							Q += S * F;
						t++
					}
					Ba.push(Q);
					Vc = o.dateTimeLabelFormats[O[0]]
				} else {
					t = ta(lb(ia / Ta) * Ta);
					n = ta(ld(ra / Ta) * Ta);
					Ba = [];
			...
			function eb() {
				var k = o.title, n = o.stackLabels, t = o.alternateGridColor, r = o.lineWidth, J, E, Q = (J = l.hasRendered)
						&& K(Bc) && !isNaN(Bc);
				...
				if (E || Ub) {
					...
					J
							|| u((o.plotLines || []).concat(o.plotBands || []),
									function($) {
				...
				if (r) {
					J = X + (Oa ? Da : 0) + la;
					E = cb - ub - (Oa ? Aa : 0) + la;
					J = ga.crispLine([ Za, R ? X : J, R ? E : ea, Ka,
							R ? $a - Ib : J, R ? E : cb - ub ], r);
					if (La)
						La.animate({
							d : J
						});
			...
			var xa = p.isX, Oa = p.opposite, R = va ? !xa : xa, L = R ? Oa ? 0
					: 2 : Oa ? 1 : 3, s = {}, o = Ca(xa ? Wc : nd, [ ge, he,
					Td, ie ][L], p), I = this, ba, B = o.type, D = B === "datetime", ca = B === "logarithmic", la = o.offset || 0, qa = xa ? "x"
					: "y", ya, fb, Hb, cc = R ? X : ub, G, ha, na, Ra, La, pa, wa, zb, Vb, Gb, ra = null, ia = null, Bc, Sd, Qd = o.minPadding, Rd = o.maxPadding, Ub = K(o.linkedTo), Od, Pd, Tc;
			B = o.events;
			var od, Pb = [], Ta, Uc, Fb, Ba, mb = {}, Wb = {}, dc = {}, pc, qc, md, Vc, Ya = o.categories, je = o.labels.formatter
					|| function() {
						var k = this.value;
						return Vc ? Xc(Vc, k) : Ta % 1E6 === 0 ? k / 1E6 + "M"
								: Ta % 1E3 === 0 ? k / 1E3 + "k" : !Ya
										&& k >= 1E3 ? Ed(k, 0) : k
					}, Yc = R && o.labels.staggerLines, ec = o.reversed, fc = Ya
					&& o.tickmarkPlacement === "between" ? 0.5 : 0;
			q.prototype = {
				addLabel : function() {
					var k = this.pos, n = o.labels, t = !(k === ia
							&& !A(o.showFirstLabel, 1) || k === ra
							&& !A(o.showLastLabel, 0)), r = Ya && R
							&& Ya.length && !n.step && !n.staggerLines
							&& !n.rotation && Da / Ya.length || !R && Da / 2, J = Ya
							&& K(Ya[k]) ? Ya[k] : k, E = this.label;
					k = je.call({
						isFirst : k === Ba[0],
						isLast : k === Ba[Ba.length - 1],
						dateTimeLabelFormat : Vc,
					...
					r = sa(r, n.style);
					if (E === Wa)
						this.label = K(k) && t && n.enabled ? ga.text(k, 0, 0,
								n.useHTML).attr({
							align : n.align,
							rotation : n.rotation
						}).css(r).add(na) : null;
				...
				getLabelSize : function() {
					var k = this.label;
					return k ? (this.labelBBox = k.getBBox())[R ? "height"
							: "width"] : 0
				},
				render : function(k, n) {
					var t = !this.minor, r = this.label, J = this.pos, E = o.labels, Q = this.gridLine, fa = t ? o.gridLineWidth
							: o.minorGridLineWidth, ka = t ? o.gridLineColor
							: o.minorGridLineColor, $ = t ? o.gridLineDashStyle
							: o.minorGridLineDashStyle, F = this.mark, O = t ? o.tickLength
							: o.minorTickLength, S = t ? o.tickWidth
							: o.minorTickWidth || 0, aa = t ? o.tickColor
							: o.minorTickColor, Eb = t ? o.tickPosition
							: o.minorTickPosition, kb = E.step, nb = n && Zc
							|| cb, Qb;
					Qb = R ? G(J + fc, null, null, n) + cc : X + la
							+ (Oa ? (n && pd || $a) - Ib - X : 0);
					nb = R ? nb - ub + la - (Oa ? Aa : 0) : nb
					...
					if (fa) {
						...
						if (Q === Wa) {
							...
							if (t)
								Q.zIndex = 1;
							this.gridLine = Q = fa ? ga.path(J).attr(Q).add(Ra)
									: null
						}
						!n && Q && J && Q.animate({
							d : J
					...
					if (S) {
						...
						if (Oa)
							O = -O;
						t = ga.crispLine([ Za, Qb, nb, Ka, Qb + (R ? 0 : -O),
								nb + (R ? O : 0) ], S);
						if (F)
							F.animate({
								d : t
			...
			x.prototype = {
				...
				render : function(k) {
					...
					if (this.label)
						...
						this.label = l.renderer.text(n, 0, 0).css(
				...
				setOffset : function(k, n) {
					var t = this.isNegative, r = I.translate(this.total), J = I
							.translate(0);
					J = bb(r - J);
					...
					this.label
							&& this.label.align(this.alignOptions, null, t)
									.attr({
										visibility : Ab
									})
				}
			...
			sa(
					I,
					{
						...
						getOffset : function() {
							var k = zb.length && K(ia) && K(ra), n = 0, t = 0, r = o.title, J = o.labels, E = [
									-1, 1, 1, -1 ][L], Q;
							if (!na) {
								na = ga.g("axis").attr({
									zIndex : 7
							...
							if (r && r.text) {
								if (!ba) {
									ba = I.axisTitle = ga.text(r.text, 0, 0,
											r.useHTML).attr({
										zIndex : 7,
		...
		function e(p) {
			function q() {
				var B = this.points || xc(this), D = B[0].series.xAxis, ca = this.x;
				D = D && D.options.type === "datetime";
				var la = Sb(ca) || D, qa;
				qa = la ? [ '<span style="font-size: 10px">'
						+ (D ? Xc("%A, %b %e, %Y", ca) : ca) + "</span>" ] : [];
				u(B, function(ya) {
			...
			var V, N = p.borderWidth, ta = p.crosshairs, da = [], Ma = p.style, za = p.shared, eb = ja(Ma.padding), ab = N
					+ eb, xa = true, Oa, R, L = 0, s = 0;
			Ma.padding = 0;
			var o = ga.g("tooltip").attr({
				zIndex : 8
			}).add(), I = ga.rect(ab, ab, 0, 0, p.borderRadius, N).attr({
				fill : p.backgroundColor,
				"stroke-width" : N
			}).add(o).shadow(p.shadow), ba = ga.text("", eb + ab,
					ja(Ma.fontSize) + eb + ab, p.useHTML).attr({
				zIndex : 1
			}).css(Ma).add(o);
			o.hide();
			return {
				...
				refresh : function(B) {
					...
					if (ya === false || !la)
						...
						I.attr({
							width : Oa,
							height : R,
							stroke : p.borderColor || B.color || V.color
									|| "#606060"
						});
		...
		function f(p) {
			...
			function w(L) {
				...
				u(Va, function(o) {
					...
					s[ba ? "xAxis" : "yAxis"].push({
						axis : o,
						value : I((va ? !ba : ba) ? L.chartX - X : Aa
								- L.chartY + ea, true)
					})
				});
				return s
			...
			function V() {
				if (za) {
					...
					if (Ma) {
						u(Va, function(ba) {
							var B = ba.translate, D = ba.isXAxis, ca = va ? !D
									: D, la = B(ca ? o : Aa - I - s.height,
									true, 0, 0, 1);
				...
				l.mouseIsDown = td = Ma = false;
				vb(ua, Kb ? "touchend" : "mouseup", V)
			}
			function N(L) {
			...
			var ta, da, Ma, za, eb = z.zoomType, ab = /x/.test(eb), xa = /y/
					.test(eb), Oa = ab && !va || xa && va, R = xa && !va || ab
					&& va;
			$c = function() {
				if (Cc) {
					Cc.translate(X, ea);
					...
					l.trackerGroup = Cc = ga.g("tracker").attr({
						zIndex : 9
					}).add()
			};
			$c();
			...
			(function() {
				...
				var L = function(s) {
					if (!(s && s.touches && s.touches.length > 1)) {
						...
						if (td && s.type !== "touchstart") {
							Ma = Math.sqrt(Math.pow(ta - o, 2)
									+ Math.pow(da - I, 2));
							if (Ma > 10) {
								if (rc && (ab || xa) && gc(ta - X, da - ea))
									za
											|| (za = ga
													.rect(X, ea, Oa ? 1 : Da,
															R ? 1 : Aa, 0)
							...
							I = l.hoverPoint;
							o = l.hoverSeries;
							var D, ca, la = $a, qa = va ? s.chartY : s.chartX
									- X;
							if (hc && p.shared) {
								B = [];
								D = Ha.length;
								...
								if (B.length && B[0].plotX !== rd) {
									hc.refresh(B);
									rd = B[0].plotX
								}
							}
							if (o && o.tracker)
								(s = o.tooltipPoints[qa]) && s !== I
										&& s.onMouseOver()
						}
						return ba || !rc
					}
			...
			sa(
					this,
					{
						...
						destroy : function() {
							if (l.trackerGroup)
								l.trackerGroup = Cc = l.trackerGroup.destroy();
							vb(ua, "mousemove", N);
		...
		function m(p, q) {
			tc = Ca(a.title, p);
			Gc = Ca(a.subtitle, q);
			u([ [ "title", p, tc ], [ "subtitle", q, Gc ] ], function(w) {
		...
		function v() {
			...
			bd = (Zb || pb).offsetWidth;
			Hc = (Zb || pb).offsetHeight;
			l.chartWidth = $a = z.width || bd || 600;
			l.chartHeight = cb = z.height || (Hc > 19 ? Hc : 400);
			...
			l.renderer = ga = z.forExport ? new cd(oa, $a, cb, true) : new dd(
					oa, $a, cb);
			var p, q;
		...
		function P() {
			function p() {
				var w = z.width || pb.offsetWidth, x = z.height
						|| pb.offsetHeight;
				if (w && x) {
					if (w !== bd || x !== Hc) {
						clearTimeout(q);
		...
		function Y() {
			...
			p.items
					&& u(p.items,
							function() {
								var x = sa(p.style, this.style), V = ja(x.left)
										+ X, N = ja(x.top) + ea + 12;
								delete x.left;
								delete x.top;
		...
		function H() {
			...
			if (l !== null) {
				...
				for (p = Ha.length; p--;)
					Ha[p] = Ha[p].destroy();
				u([ "title", "subtitle", "seriesGroup", "clipRect", "credits",
						"tracker" ], function(w) {
					var x = l[w];
					if (x)
						l[w] = x.destroy()
				});
				u([ vc, Dc, hc, ga, Yb ], function(w) {
		...
		function U() {
			if (!Ic && db == db.top && ua.readyState !== "complete")
		...
		M = Nb(M) ? M : [ M, M, M, M ];
		var y = A(z.marginTop, M[0]), C = A(z.marginRight, M[1]), Z = A(
				z.marginBottom, M[2]), Sa = A(z.marginLeft, M[3]), Na = z.spacingTop, Ea = z.spacingRight, gb = z.spacingBottom, Lb = z.spacingLeft, Rb, tc, Gc, ea, Ib, ub, X, Xb, pb, Zb, oa, Wd, bd, Hc, $a, cb, pd, Zc, vc, zd, Ad, ed, l = this, ke = (M = z.events)
				&& !!M.click, Bd, gc, hc, td, jc, Zd, Cd, Aa, Da, Yb, Cc, $c, Dc, $b, ac, Jb, rc = z.showAxes, ad = 0, Va = [], Ob, Ha = [], va, ga, qd, Vd, rd, ud, Ec, xd, yd, wd, sd, $d, le = function() {
			function p(G, ha) {
				var na = G.legendItem, Ra = G.legendLine, La = G.legendSymbol, pa = Oa.color, wa = ha ? N.itemStyle.color
						: pa, zb = ha ? G.color : pa;
			...
			function w() {
				u(za, function(G) {
					...
					ha
							&& Ja(ha, {
								left : na.translateX + G.legendItemWidth + ha.x
										- 40 + Ua,
			...
			function x(G) {
				...
				if (!pa) {
					...
					G.legendItem = pa = ga.text(N.labelFormatter.call(G), 0, 0)
							.css(G.visible ? ab : Oa).on("mouseover",
									function() {
										G.setState(Bb);
										pa.css(xa)
								...
								G.setState()
									...
									function() {
										...
										G.firePointEvent ? G.firePointEvent(
												"legendItemClick", null, Gb)
												: Pa(G, "legendItemClick",
														null, Gb)
									}).attr({
								zIndex : 2
							}).add(qa);
					if (!La && wa && wa.lineWidth) {
						...
						G.legendLine = ga.path([ Za, -da - Ma, 0, Ka, -Ma, 0 ])
								.attr(Vb).add(qa)
					}
					if (La)
						...
						ha = ga.symbol(G.symbol, na = -da / 2 - Ma, Ra = -4,
								wa.marker.radius).attr({
							zIndex : 3
						}).add(qa);
					if (ha) {
						ha.xOff = na + zb % 2 / 2;
			...
			function V() {
				...
				u(Hb, function(Ra) {
					...
					if (La.showInLegend)
						za = za
								.concat(La.legendType === "point" ? Ra.data
										: Ra)
				});
				...
				if (ca || la) {
					...
					if (D) {
						if ($b > 0 && ac > 0) {
							D[D.isNew ? "attr" : "animate"](D.crisp(null, null,
									null, $b, ac));
							D.isNew = false
						}
					} else {
			...
			if (N.enabled) {
				var ta = N.layout === "horizontal", da = N.symbolWidth, Ma = N.symbolPadding, za, eb = N.style, ab = N.itemStyle, xa = N.itemHoverStyle, Oa = N.itemHiddenStyle, R = ja(eb.padding), L = 18, s = 4
						+ R + da + Ma, o, I, ba, B = 0, D, ca = N.borderWidth, la = N.backgroundColor, qa, ya, fb = N.width, Hb = l.series, cc = N.reversed;
				V();
				Qa(l, "endResize", w);
				return {
					colorizeItem : p,
		...
		Ec = function() {
			...
			if ((l.title || l.subtitle) && !K(y))
				if (ta = Ia(l.title && !tc.floating && !tc.verticalAlign
						&& tc.y || 0, l.subtitle && !Gc.floating
						&& !Gc.verticalAlign && Gc.y || 0))
					ea = Ia(ea, ta + A(tc.margin, 15) + Na);
		...
		wd = function(p, q, w) {
			...
			Zc = null;
			Pa(l, "resize");
			zc === false ? T() : setTimeout(T, zc && zc.duration || 500)
		};
		yd = function() {
			l.plotLeft = X = W(X);
			l.plotTop = ea = W(ea);
			l.plotWidth = Da = W($a - X - Ib);
			l.plotHeight = Aa = W(cb - ea - ub);
		...
		ud = function() {
			...
			if (p || q)
				if (vc)
					vc.animate(vc.crisp(null, null, null, $a - V, cb - V));
				else
					vc = ga.rect(V / 2, V / 2, $a - V, cb - V, z.borderRadius,
							p).attr({
			...
			if (z.plotBorderWidth)
				if (ed)
					ed.animate(ed.crisp(null, X, ea, Da, Aa));
				else
					ed = ga.rect(X, ea, Da, Aa, 0, z.plotBorderWidth).attr({
	...
	var ua = document, db = window, Fa = Math, W = Fa.round, lb = Fa.floor, ld = Fa.ceil, Ia = Fa.max, sb = Fa.min, bb = Fa.abs, qb = Fa.cos, Cb = Fa.sin, kc = Fa.PI, ae = kc * 2 / 360, wc = navigator.userAgent, Mc = /msie/i
			.test(wc)
			&& !db.opera, Jc = ua.documentMode === 8, Ud = /AppleWebKit/
			.test(wc), Yd = /Firefox/.test(wc), Ic = !!ua.createElementNS
			&& !!ua.createElementNS("http://www.w3.org/2000/svg", "svg").createSVGRect, me = Yd
			&& parseInt(wc.split("Firefox/")[1], 10) < 4, dd, Kb = ua.documentElement.ontouchstart !== undefined, be = {}, vd = 0, tb = 1, Rc, Xa, Xc, zc, Kc, Wa, Tb = "div", ic = "absolute", Xd = "relative", ob = "hidden", uc = "highcharts-", Ab = "visible", Ua = "px", jb = "none", Za = "M", Ka = "L", ce = "rgba(192,192,192,"
			+ (Ic ? 1.0E-6 : 0.0020) + ")", ib = "", Bb = "hover", Nc, hd, id, jd, Ac, Oc, Pc, Jd, Kd, kd, Ld, Md, ma = db.HighchartsAdapter, Db = ma
			|| {}, u = Db.each, Dd = Db.grep, sc = Db.map, Ca = Db.merge, Qa = Db.addEvent, vb = Db.removeEvent, Pa = Db.fireEvent, fd = Db.animate, Fc = Db.stop, wb = {};
	Xc = function(a, b, c) {
		function d(P) {
		...
		a = A(a, "%Y-%m-%d %H:%M:%S");
		b = new Date(b * tb);
		var e, f = b[id](), g = b[jd](), h = b[Ac](), i = b[Oc](), j = b[Pc](), m = Xa.lang, v = m.weekdays;
		b = {
			a : v[g].substr(0, 3),
			A : v[g],
			d : d(h),
	...
	Kc = {
		init : function(a, b, c) {
			...
			var h, i, j = function(m) {
				for (g = m.length; g--;)
					m[g] === Za
							&& m.splice(g + 1, 0, m[g + 1], m[g + 2], m[g + 1],
									m[g + 2])
			};
			if (e) {
				j(b);
	...
	if (!ma && db.jQuery) {
		...
		vb = function(a, b, c) {
			var d = ua.removeEventListener ? "removeEventListener"
					: "detachEvent";
			if (ua[d] && !a[d])
				a[d] = function() {
				};
		...
		u([ "cur", "_default", "width", "height" ], function(a, b) {
			...
			if (d)
				c[a] = function(f) {
					f = b ? f : this;
					e = f.elem;
					return e.attr ? e.attr(f.prop, f.now) : d.apply(this,
							arguments)
				}
		});
		ee.d = function(a) {
			var b = a.elem;
			if (!a.started) {
				var c = Kc.init(b, b.d, b.toD);
				a.start = c[0];
				a.end = c[1];
				a.started = true
			}
			b.attr("d", Kc.step(a.start, a.end, a.pos, b.toD))
		}
	}
	ma = {
		enabled : true,
	...
	Xa = {
		...
		lang : {
			...
			months : [ "January", "February", "March", "April", "May", "June",
					...
					"December" ],
			shortMonths : [ "Jan", "Feb", "Mar", "Apr", "May", "June", "Jul",
					"Aug", "Sep", "Oct", "Nov", "Dec" ],
	...
	Sc.prototype = {
			...
			if (Sb(a)) {
				...
				for (c in a) {
					...
					if (c === "d") {
						...
						if (this.rotation)
							Ga(g, "transform", "rotate(" + this.rotation + " "
									+ d + " " + ja(a.y || Ga(g, "y")) + ")")
					} else if (c === "fill")
						d = i.color(d, g, c);
						...
						e = ua.createElementNS("http://www.w3.org/2000/svg",
								"title");
		...
		getBBox : function() {
			...
			c = a.height;
			if (d) {
				a.width = bb(c * Cb(e)) + bb(b * qb(e));
				a.height = bb(c * qb(e)) + bb(b * Cb(e))
			}
			return a
		},
		show : function() {
		...
		add : function(a) {
			var b = this.renderer, c = a || b, d = c.element || b.box, e = d.childNodes, f = this.element, g = Ga(
					f, "zIndex");
		...
		destroy : function() {
			var a = this.element || {}, b = this.shadows, c = a.parentNode, d, e;
			a.onclick = a.onmouseout = a.onmouseover = a.onmousemove = null;
			Fc(this);
			if (this.clipPath)
				this.clipPath = this.clipPath.destroy();
			if (this.stops) {
				for (e = 0; e < this.stops.length; e++)
					this.stops[e] = this.stops[e].destroy();
				this.stops = null
			}
			c && c.removeChild(a);
			b && u(b, function(f) {
			...
			nc(this.renderer.alignedObjects, this);
			for (d in this)
				delete this[d];
			return null
		},
	...
	cd.prototype = {
		...
		buildText : function(a) {
			for ( var b = a.element, c = A(a.textStr, "").toString().replace(
					/<(b|strong)>/g, '<span style="font-weight:bold">')
					.replace(/<(i|em)>/g, '<span style="font-style:italic">')
					.replace(/<a/g, "<span").replace(/<\/(b|strong|i|em|a)>/g,
							"</span>").split(/<br.*?>/g), d = b.childNodes, e = /style="([^"]+)"/, f = /href="([^"]+)"/, g = Ga(
					b, "x"), h = a.styles, i = h && a.useHTML
					&& !this.forExport, j = a.htmlNode, m = h && ja(h.width), v = h
					&& h.lineHeight, P, T = d.length; T--;)
				b.removeChild(d[T]);
		...
		symbols : {
			square : function(a, b, c) {
				c = 0.707 * c;
				return [ Za, a - c, b - c, Ka, a + c, b - c, a + c, b + c,
						a - c, b + c, "Z" ]
			},
			triangle : function(a, b, c) {
				return [ Za, a, b - 1.33 * c, Ka, a + c, b + 0.67 * c, a - c,
						b + 0.67 * c, "Z" ]
			},
			...
			arc : function(a, b, c, d) {
				var e = d.start, f = d.end - 1.0E-6, g = d.innerR, h = qb(e), i = Cb(e), j = qb(f);
				f = Cb(f);
				d = d.end - e < kc ? 0 : 1;
				return [ Za, a + c * h, b + c * i, "A", c, c, 0, d, 1,
						a + c * j, b + c * f, Ka, a + g * j, b + g * f, "A", g,
						g, 0, d, 0, a + g * h, b + g * i, "Z" ]
			}
		},
		clipRect : function(a, b, c, d) {
			var e = uc + vd++, f = this.createElement("clipPath").attr({
				id : e
			}).add(this.defs);
		...
		Db = yb(
				Sc,
				{
					...
					attr : function(a, b) {
						...
						if (Sb(a)) {
							c = a;
							T = c === "strokeWidth" || c === "stroke-width" ? this.strokeweight
									: this[c]
						} else
							for (c in a) {
								d = a[c];
								...
								if (j
									...
									(f.getElementsByTagName("stroke")[0] || hb(
											i.prepVML([ "<stroke/>" ]), null,
											null, f))[c] = d || "solid";
									this.dashstyle = d;
									m = true
								} else if (c === "fill")
					...
					destroy : function() {
						...
						return Sc.prototype.destroy.apply(this)
					},
					empty : function() {
					...
					shadow : function(a, b) {
						...
						if (a) {
							for (d = 1; d <= 3; d++) {
								i = [ '<shape isShadow="true" strokeweight="',
										7 - 2 * d, '" filled="false" path="',
										j, '" coordsize="100,100" style="',
										e.style.cssText, '" />' ];
								g = hb(f.prepVML(i), null, {
									left : ja(h.left) + 1,
									top : ja(h.top) + 1
								});
								i = [ '<stroke color="black" opacity="',
										0.05 * d, '"/>' ];
				...
				cd.prototype,
				{
					...
					clipRect : function(a, b, c, d) {
						...
						return sa(e, {
							...
							height : d,
							getCSS : function(f) {
								var g = this.top, h = this.left, i = h
										+ this.width, j = g + this.height;
								g = {
									clip : "rect(" + W(f ? h : g) + "px,"
											+ W(f ? j : i) + "px,"
											+ W(f ? i : j) + "px,"
											+ W(f ? g : h) + "px)"
								};
					...
					color : function(a, b, c) {
						...
						if (a && a.linearGradient) {
							...
							a = 90 - Fa.atan((h[3] - h[1]) / (h[2] - h[0]))
									* 180 / kc;
							a = [ "<", c, ' colors="0% ', i, ",100% ", m,
									'" angle="', a, '" opacity="', v,
									'" o:opacity2="', j,
					...
					symbols : {
						arc : function(a, b, c, d) {
							var e = d.start, f = d.end, g = qb(e), h = Cb(e), i = qb(f), j = Cb(f);
							d = d.innerR;
							...
							return [ "wa", a - c, b - c, a + c, b + c,
									a + c * g, b + c * h, a + c * i, b + c * j,
									"at", a - d, b - d, a + d, b + d,
									a + d * i, b + d * j, a + d * g, b + d * h,
									"x", "e" ]
						},
						circle : function(a, b, c) {
						...
						rect : function(a, b, c, d) {
							...
							var f = a + e, g = b + d;
							c = sb(c, e, d);
							return [ Za, a + c, b, Ka, f - c, b, "wa",
									f - 2 * c, b, f, b + 2 * c, f - c, b, f,
									b + c, Ka, f, g - c, "wa", f - 2 * c,
									g - 2 * c, f, g, f, g - c, f - c, g, Ka,
									a + c, g, "wa", a, g - 2 * c, a + 2 * c, g,
									a + c, g, a, g - c, Ka, a, b + c, "wa", a,
	...
	Lc.prototype = {
		...
		setState : function(a) {
			var b = this.series, c = b.options.states, d = xb[b.type].marker
					...
					&& d.states[a])
					&& d.enabled === false, g = b.stateMarkerGraphic, h = b.chart, i = this.pointAttr;
			a = a || ib;
	...
	rb.prototype = {
		...
		translate : function() {
			for ( var a = this.chart, b = this.options.stacking, c = this.xAxis.categories, d = this.yAxis, e = this.data, f = e.length; f--;) {
				var g = e[f], h = g.x, i = g.y, j = g.low, m = d.stacks[(i < 0 ? "-"
						: "")
						+ this.stackKey];
		...
		setTooltipPoints : function(a) {
			var b = this.chart, c = b.inverted, d = [], e = W((c ? b.plotTop
					: b.plotLeft)
					+ b.plotSizeX), f, g, h = [];
			if (a)
			...
			u(
					...
					function(i, j) {
						...
						for (g = i._high = d[j + 1] ? lb((i.plotX + (d[j + 1] ? d[j + 1].plotX
								: e)) / 2)
								: e; f <= g;)
							h[c ? e - f++ : f++] = i
					});
		...
		getAttribs : function() {
			...
			if (a.options.marker) {
				...
				d.color = d.color
						|| bc(d.color || f).brighten(d.brightness).get();
			...
			for (f = h.length; f--;) {
				...
				if (e) {
					...
					e = c[Bb] = c[Bb] || {};
					if (!a.options.marker)
						e.color = bc(e.color || g.options.color).brighten(
		...
		destroy : function() {
			var a = this, b = a.chart, c = a.clipRect, d = /\/5[0-9\.]+ (Safari|Mobile)\//
					.test(wc), e, f;
			Pa(a, "destroy");
			vb(a);
		...
		drawDataLabels : function() {
			if (this.options.dataLabels.enabled) {
				...
				u(
						c,
						function(H) {
							var U = H.barX, z = U && U + H.barW / 2 || H.plotX
									|| -999, M = A(H.plotY, -999), y = H.dataLabel, C = e.align, Z = Y ? H.y >= 0 ? -6
									: 12
									: e.y;
							...
							if (y) {
								if (j && !e.y)
									b = b + ja(y.styles.lineHeight) * 0.9
											- y.getBBox().height / 2;
								y.attr({
									text : f
								}).animate({
								...
								y = H.dataLabel = i.text(f, a, b).attr({
									align : C,
									rotation : e.rotation,
									zIndex : 1
								}).css(e.style).add(g);
								j
										&& !e.y
										&& y.attr({
											y : b + ja(y.styles.lineHeight)
													* 0.9 - y.getBBox().height
													/ 2
										})
							}
							if (P && d.stacking && y) {
		...
		drawGraph : function() {
			var a = this, b = a.options, c = a.graph, d = [], e, f = a.area, g = a.group, h = b.lineColor
					|| a.color, i = b.lineWidth, j = b.dashStyle, m, v = a.chart.renderer, P = a.yAxis
					.getThreshold(b.threshold || 0), T = /^area/.test(a.type), Y = [], H = [];
			u(a.segments,
					function(U) {
						m = [];
						u(U, function(C, Z) {
						...
						if (T) {
							...
							if (b.stacking && a.type !== "areaspline")
								...
								z.push(Ka, U[U.length - 1].plotX, P, Ka,
										U[0].plotX, P);
							H = H.concat(z)
						}
					});
		...
		render : function() {
			...
			if (!h) {
				h = a.clipRect = !b.hasRendered && b.clipRect ? b.clipRect : i
				...
				getPointSpline : function(a, b, c) {
					...
					if (c) {
						b = [ "C", f.rightContX || f.plotX,
								f.rightContY || f.plotY, h || d, i || e, d, e ];
	...
	var gd = yb(
			rb,
			{
				...
				translate : function() {
					...
					h = bb(v[1] ? v[P].plotX - v[P - 1].plotX : b.plotSizeX
							/ (h && h.length || 1));
					P = h * c.groupPadding;
					var T = (h - 2 * P) / f, Y = c.pointWidth, H = K(Y) ? (T - Y) / 2
							: T * c.pointPadding, U = Ia(A(Y, T - 2 * H), 1), z = H
							+ (P
									+ ((g ? f - a.columnIndex : a.columnIndex) || 0)
									* T - h / 2) * (g ? -1 : 1), M = a.yAxis
							.getThreshold(c.threshold || 0), y = A(
							c.minPointLength, 5);
					u(
							v,
							function(C) {
								var Z = C.plotY, Sa = C.yBottom || M, Na = C.plotX
										+ z, Ea = ld(sb(Z, Sa)), gb = ld(Ia(Z,
										Sa)
										- Ea), Lb = a.yAxis.stacks[(C.y < 0 ? "-"
										: "")
										+ a.stackKey], Rb;
								d && a.visible && Lb && Lb[C.x]
										&& Lb[C.x].setOffset(z, U);
								if (bb(gb) < y) {
									if (y) {
										gb = y;
										Ea = bb(Ea - M) > y ? Sa - y : M
								...
								C.shapeType = "rect";
								Z = sa(b.renderer.Element.prototype.crisp
										.apply({}, [ e, Na, Ea, U, gb ]), {
									r : c.borderRadius
								});
								if (e % 2) {
	...
	ma = yb(gd, {
		...
		init : function(a) {
			...
			gd.prototype.init.apply(this, arguments)
		}
	});
	wb.bar = ma;
	ma = yb(rb, {
	...
	ma = yb(
			...
			{
				init : function() {
					Lc.prototype.init.apply(this, arguments);
					var a = this, b;
					sa(a, {
				...
				setVisible : function(a) {
					...
					g = (this.visible = a = a === Wa ? !this.visible : a) ? "show"
							: "hide";
					this.group[g]();
					c && c[g]();
					d && d[g]();
	...
	ma = yb(
			rb,
			{
				...
				translate : function() {
					var a = 0, b = -0.25, c = this.options, d = c.slicedOffset, e = d
							+ c.borderWidth, f = c.center.concat([ c.size,
							c.innerSize || 0 ]), g = this.chart, h = g.plotWidth, i = g.plotHeight, j, m, v, P = this.data, T = 2 * kc, Y, H = sb(
							h, i), U, z, M, y = c.dataLabels.distance;
					f = sc(f, function(C, Z) {
						return (U = /%$/.test(C)) ? [ h, i, H, H ][Z] * ja(C)
								/ 100 : C
					});
					this.getX = function(C, Z) {
						v = Fa.asin((C - f[1]) / (f[2] / 2 + y));
						return f[0] + (Z ? -1 : 1) * qb(v) * (f[2] / 2 + y)
					};
					this.center = f;
					u(P, function(C) {
						a += C.y
				...
				drawPoints : function() {
					...
					u(this.data, function(i) {
						...
						c = i.sliced ? i.slicedTranslation : [ a.plotLeft,
								a.plotTop ];
						e.translate(c[0], c[1]);
				...
				drawDataLabels : function() {
					var a = this.data, b, c = this.chart, d = this.options.dataLabels, e = A(
							d.connectorPadding, 10), f = A(d.connectorWidth, 1), g, h, i = A(
							d.softConnector, true), j = d.distance, m = this.center, v = m[2] / 2;
					m = m[1];
					var P = j > 0, T = [ [], [] ], Y, H, U, z, M = 2, y;
					if (d.enabled) {
						rb.prototype.drawDataLabels.apply(this);
						u(a, function(gb) {
							if (gb.dataLabel)
						...
						for (a = T[0][0] && T[0][0].dataLabel
								&& ja(T[0][0].dataLabel.styles.lineHeight); M--;) {
							...
							for (y = 0; y < Na; y++) {
								...
								Ea = H.i;
								H = H.y;
								if (Y > H && C[Ea + 1] !== null || Y < H
										&& C[Ea - 1] !== null)
									H = Y;
								Y = this
										.getX(
												Ea === 0 || Ea === C.length - 1 ? Y
														: H, M);
								g.attr({
									visibility : U,
									align : h[6]
								...
								if (P && f) {
									...
									h = i ? [ Za,
											Y + (h[6] === "left" ? 5 : -5), H,
											"C", Y, H, 2 * h[2] - h[4],
											2 * h[3] - h[5], h[2], h[3], Ka,
											h[4], h[5] ] : [ Za,
											Y + (h[6] === "left" ? 5 : -5), H,
											Ka, h[2], h[3], Ka, h[4], h[5] ];
									if (g) {
										g.animate({
											d : h
										});
				...
				drawTracker : gd.prototype.drawTracker,
				getSymbol : function() {
				}
			});
	wb.pie = ma;
