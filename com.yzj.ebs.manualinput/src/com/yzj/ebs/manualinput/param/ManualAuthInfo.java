package com.yzj.ebs.manualinput.param;
 ...
 * @version 1.0
 */
public class ManualAuthInfo implements Serializable{
	
	private static final long serialVersionUID = -6229519578435803629L;

	public ManualAuthInfo(int i){
		
	}
	public ManualAuthInfo(){
	}
