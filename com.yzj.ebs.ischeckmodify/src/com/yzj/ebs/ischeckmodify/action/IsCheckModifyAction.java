package com.yzj.ebs.ischeckmodify.action;
...
import com.yzj.ebs.ischeckmodify.queryparam.AcountInfoQueryParam;
 ...
 * @version 1.0.0
 */
public class IsCheckModifyAction extends ActionSupport {

	private static final long serialVersionUID = -1742330773852472864L;
	private static WFLogger logger = WFLogger.getLogger(IsCheckModifyAction.class);
	...
	private IIsCheckModifyBiz accModifyBiz;
	...
	public IIsCheckModifyBiz getAccModifyBiz() {
		return accModifyBiz;
	}

	public void setAccModifyBiz(IIsCheckModifyBiz accModifyBiz) {
