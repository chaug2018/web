...
public class BMPMetadata extends IIOMetadata implements BMPConstants {
	...
	public BMPMetadata() {
		super(true, formatName, "uk.co.mmscomputing.imageio.bmp.BMPMetadata",
				null, null);
	...
	private String countBits(int mask) { // masks: i.e. 0x00FF0000,
											// 0x0000FF00, 0x000003E0,
											// 0x0000001F
...
/*
 * <javax_imageio_1.0> <Compression> <CompressionTypeName value="BI_RGB"></CompressionTypeName>
 * </Compression> <Data> <BitsPerSample value="8 8 8 "></BitsPerSample> </Data>
 * <Dimension> <PixelAspectRatio value="1.0"></PixelAspectRatio>
 ...
 * </Dimension> </javax_imageio_1.0>
 * 
 * <javax_imageio_bmp_1.0> <BMPVersion>BMP v. 3.x</BMPVersion> <Width>1700</Width>
 * <Height>2338</Height> <BitsPerPixel>24</BitsPerPixel> <Compression>0</Compression>
 * <ImageSize>0</ImageSize> <PixelsPerMeter> <X>2834</X> <Y>2834</Y>
 * </PixelsPerMeter> <ColorsUsed>0</ColorsUsed> <ColorsImportant>0</ColorsImportant>
