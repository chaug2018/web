...
public class EbsTempdetailmaindata implements java.io.Serializable {
	...
	/** default constructor */
	public EbsTempdetailmaindata() {
	}

	/** minimal constructor */
	public EbsTempdetailmaindata(String docdate) {
		this.docdate = docdate;
	}

	/** full constructor */
	public EbsTempdetailmaindata(String idbank, String bankname,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof EbsTempdetailmaindata))
			return false;
		EbsTempdetailmaindata castOther = (EbsTempdetailmaindata) other;
